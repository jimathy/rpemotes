Config.Languages = {
    ...
    ['da'] = { -- Danish 🇩🇰
        ...
        ['animalemotes'] = "🐩 Dyre-emotes",
        ['propemotes'] = "📦 Rekvisitemotes",
        ['favoriteemotes'] = "🌟 Favoritter",
        ['favoriteinfo'] = "Vælg en emote her for at sætte den som din favorit.",
        ['rfavorite'] = "Nulstil Favorit",
        ['prop2info'] = "❓ Rekvisitemotes findes i slutningen",
        ['set'] = "Sæt (",
        ['setboundemote'] = ") som din bundne emote?",
        ['newsetemote'] = "~w~ er nu din favorit emote, tryk ~g~CapsLock~w~ for at bruge den.",
        ['cancelemote'] = "Annuller emote",
        ['cancelemoteinfo'] = "~r~X~w~ annuller den igangværende emote.",
        ['walkingstyles'] = "Gåstilarter",
        ...
        ['nocancel'] = "Ingen emote at annullere",
        ['maleonly'] = "Denne emote er kun til mænd, desværre!",
        ['emotemenucmd'] = "Brug kommandoen /emotemenu for at tilgå emote-menuen",
        ['shareemotes'] = "👫 Delte emotes",
        ['shareemotesinfo'] = "Invitér en person i nærheden til at emote sammen",
        ['sharedanceemotes'] = "🕺 Partner emotes",
        ['notvalidsharedemote'] = "er ikke en gyldig partner emote.",
        ...
        ['bound'] = "Bundet ",
        ['to'] = "til",
        ['currentlyboundemotes'] = " Gemte emotes:",
        ['notvalidkey'] = "er ikke en gyldigt nøgle.",
        ['keybinds'] = "🔢 Foretrukne",
        ['keybindsinfo'] = "Brug",
        ['searchemotes'] = "🔍 Søg efter emotes",
        ...
        ['searchcantsetfav'] = "Partner-emotes kan ikke gøres til favoritter.",
        ['invalidvariation'] = "Ugyldig teksturvariation. Gyldige valgmuligheder er: %s",
        ['firework'] = "Tryk på ~y~G~w~ for at bruge fyrværkeri",
        ['poop'] = "Tryk på ~y~G~w~ for at lave pøller",
        ['puke'] = "Tryk ~y~G~w~ for at kaste op",---- Translated via smodin.io
        ['btn_select'] = "Vælg",
        ['btn_back'] = "Tilbage",
        ['btn_switch'] = "Bevægelse",
        ['btn_increment'] = "Stigning"
    },
    ['nl'] = { -- Dutch 🇳🇱
        ['emotes'] = 'Animaties 🎬',
